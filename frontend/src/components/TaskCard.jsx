...
const TaskCard = ({ task, index, handleTaskChange }) => {
    ...
    const updateTask = async () => {
        try {
            ...
            toast.success(`Task da doi ten thanh: ${updateTaskTitle}`);
            handleTaskChange();
        } catch (error) {
            console.error("Loi khi update task, ", error);
    ...
    const toggleTaskComplete = async () => {
        try {
            ...
            console.error("Loi khi update task status, ", error);
            toast.error("Loi xay ra khi update task status.");
        }
    }
    return (
        <Card className={cn(
                ...
                <div className="flex-1 min-w-0">
                    {isEditting ? (
                        <Input
                            ...
                            onKeyPress={(event) => handleKeyPress(event, updateTask)}
                        />
                    ) : (
                        <p
                            className={cn(
                    ...
                    {/* hien thi ngay tao va ngay hoan thanh */}
